        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="col-xs-6 col-sm-7 text-right">
                <ul class="navbar-nav mr-auto float-right">
					...
					<li class="nav-item">
                        <a title="<?php echo lng('Database') ?>" class="nav-link" href="../"><i class="fa fa-database"></i> <?php echo lng('Database') ?></a>
                    </li>
                    <?php endif; ?>
                    <?php if (FM_USE_AUTH): ?>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Tiny File Manager';      $tr['en']['AppTitle']           = 'localhost';
